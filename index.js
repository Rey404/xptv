...
async function starts() {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["wa.me/6289677763976@s.whatsapp.net"] // replace this with your number
			const adminbotnumber = ["wa.me/6289677763976@s.whatsapp.net"]
			const frendsowner = ["wa.me/6289677763976@s.whatsapp.net"]
			...
			case 'creator':
                 ...
                 client.sendMessage(from, 'itu nomer pacar ku, eh owner ku ><',MessageType.text, { quoted: mek} )
                 break
                 case 'fitnah':	
				case 'fake':          
				...
				case 'galaxtext':
					...
					reply(mess.wait)
					buffer = await getBuffer(`https://api.vhtear.com/galaxytext?text=${teks}&apikey=VHgsu8829hhuaiBahaki`)
				...
				case 'primbonjodoh':
					...
					var gbl1 = gh.split("|")[0];
					var gbl2 = gh.split("|")[1];
					anu = await fetchJson(`https://api.vhtear.com/primbonjodoh?nama=${gbl1}&pasangan=${gbl2}&apikey=VHgsu8829hhuaiBahaki`)
				...
				case 'ramaljadian':
					...
					var gbl2 = gh.split("|")[1];
					var gbl3 = gh.split("|")[2];
					anu = await fetchJson(`https://api.vhtear.com/harijadian?tgl=${gbl1}&bln=${gbl2}&thn=${gbl3}&apikey=VHgsu8829hhuaiBahaki`)
					reply(anu.result.hasil)
					break
                case 'tahta':
					...
					reply(mess.wait)
					buffer = await getBuffer(`https://api.vhtear.com/hartatahta?text=${teks}&apikey=VHgsu8829hhuaiBahaki`)
				...
				case 'lovemake':
					...
					reply(mess.wait)
					buffer = await getBuffer(`https://api.vhtear.com/lovemessagetext?text=${love}&apikey=VHgsu8829hhuaiBahaki`)
				...
				case 'thunder':
					...
					reply(mess.wait)
					buffer = await getBuffer(`https://api.vhtear.com/thundertext?text=${thun}&apikey=VHgsu8829hhuaiBahaki`)
                ...
                case 'stiltext':
                      ...
                      gl1 = gh.split("|")[0];
                      gl2 = gh.split("|")[1];
                      buff = await getBuffer(`https://api.vhtear.com/silktext?text=${gl1}&text2=${gl2}&apikey=VHgsu8829hhuaiBahaki`)
                      reply(mess.wait)
				...
				case 'testing2':
					...
					if (args.length < 1) return reply('Teks nya mana?')
					reply(mess.wait)
					party = await getBuffer(`https://api.vhtear.com/partytext?text=${coli1}&text2=${coli2}&apikey=VHgsu8829hhuaiBahaki`)
				...
				case 'party':
					...
					reply(mess.wait)
					buffer = await getBuffer(`https://api.vhtear.com/partytext?text=${part}&apikey=VHgsu8829hhuaiBahaki`)
				...
				case 'rtext':
					...
					reply(mess.wait)
					buffer = await getBuffer(`https://api.vhtear.com/romancetext?text=${tels5}&apikey=VHgsu8829hhuaiBahaki`)
				...
				case 'watercolor':
					...
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/watercolour_text?text1=${tels}&apikey=VHgsu8829hhuaiBahaki`, {method: 'get'})
               ...
               client.reply(from, `Waalaikumsalam ${pushname}:)`)
				...
				case 'walpaperhd':
					...
					teks = body.slice(7)
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/walpaper?query=${teks}&apikey=VHgsu8829hhuaiBahaki`)
				...
				case 'wibu':
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/randomwibu&apikey=VHgsu8829hhuaiBahaki`)
					if (anu.error) return reply(anu.error)
				...
				case 'randomcat':
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/randomcat?apikey=VHgsu8829hhuaiBahaki`)
					if (anu.error) return reply(anu.error)
				...
				case 'mlherolist':
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/mlherolist?apikey=VHgsu8829hhuaiBahaki`)
				...
				case 'ramalhp':
					if (args.length < 1) return reply('teks nya mana om')
					kj = body.slice(12)
					anu = await fetchJson(`https://api.vhtear.com/nomerhoki?no=${kj}&apikey=VHgsu8829hhuaiBahaki`)
					reply(anu.result.hasil)
					break
				case 'textscreen':
					if (args.length < 1) return reply('teks nya mana om')
					tels = body.slice(9)
					anu = await fetchJson(`https://api.vhtear.com/textscreen?query=${tels}&apikey=VHgsu8829hhuaiBahaki`, {method: 'get'})
					reply(anu.result.text)
					break
			    case 'joox':
				if (args.length < 1) return reply('Nama lagunya apa kak?')
                    anu = await fetchJson(`https://api.vhtear.com/ytmp3?query=${body.slice(6)}&apikey=VHgsu8829hhuaiBahaki`)
               ...
               case 'infogempa':
                ...
                case 'infocuaca':
                   ...
                   break
                case 'tebakgambar':
					anu = await fetchJson(`https://api.vhtear.com/tebakgambar&apikey=VHgsu8829hhuaiBahaki`, {method: 'get'})
					...
					break
                case 'caklontong':
					anu = await fetchJson(`https://api.vhtear.com/funkuis&apikey=VHgsu8829hhuaiBahaki`, {method: 'get'})
					setTimeout( () => {
					...
					break
				case 'family100':
					anu = await fetchJson(`https://api.vhtear.com/family100&apikey=VHgsu8829hhuaiBahaki`, {method: 'get'})
					setTimeout( () => {
					client.sendMessage(from, '*➸ Jawaban :* '+anu.result.jawaban, text, {quoted: mek}) // ur cods
					}, 30000) // 1000 = 1s,
					setTimeout( () => {
                ...
                case 'brainly':
					...
					anu = await fetchJson(`https://api.vhtear.com/branly?query=${body.slice(9)}&apikey=VHgsu8829hhuaiBahaki`, {method: 'get'})
					reply(anu.result.data)
					break
                case 'image':
					if (args.length < 1) return reply('Apa yang mau dicari kak?')
					goo = body.slice(7)
					anu = await fetchJson(`https://api.vhtear.com/googleimg?query=${goo}&apikey=VHgsu8829hhuaiBahaki`, {method: 'get'})
					reply(mess.wait)
                ...
                case 'pokemon':
					...
					break
				case 'inu':
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=inu&apikey=VHgsu8829hhuaiBahaki`, {method: 'get'})
					...
					break
				case 'elang':
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=elang&apikey=VHgsu8829hhuaiBahaki`, {method: 'get'})
					...
					break
				case 'babi':
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=babi&apikey=VHgsu8829hhuaiBahaki`, {method: 'get'})
					...
					break
				case 'unta':
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=unta&apikey=VHgsu8829hhuaiBahaki`, {method: 'get'})
                ...
                case 'pinterest':
					...
					pinte = body.slice(11)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=${pin}&apikey=VHgsu8829hhuaiBahaki`, {method: 'get'})
					reply(mess.wait)
				...
				case 'tulis':
					...
					tulis = body.slice(6)
					reply(mess.wait)
					buffer = await getBuffer(`https://api.vhtear.com/write?text=${tulis}&apikey=VHgsu8829hhuaiBahaki`)
			    ...
			    case 'lovemake':
                    ...
                    teks = `${body.slice(8)}`
                    if (teks.length > 10) return client.sendMessage(from, 'Teksnya kepanjangan, Maksimal 10 kalimat', text, {quoted: mek})
                    buff = await getBuffer(`https://api.vhtear.com/lovemessagetext?text=${teks}&apikey=VHgsu8829hhuaiBahaki`, {method: 'get'})
                    client.sendMessage(from, buff, image, {quoted: mek, caption: `${teks}`})
			     	break
			    case 'shorturl':
			    ...
			    case 'igstalk':
					...
					ige = body.slice(9)
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/igprofile?query=${ige}&apikey=VHgsu8829hhuaiBahaki`, {method: 'get'})
				...
				case 'infomobil':
					...
					ige = body.slice(9)
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/infomobil?merk=${ige}&apikey=VHgsu8829hhuaiBahaki`, {method: 'get'})
				...
				case 'infomotor':
					...
					ft1 = body.slice(11)
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/infomotor?merk=${ft1}&apikey=VHgsu8829hhuaiBahaki`)
					buffer = await getBuffer(anu.result.image)
				...
				case 'playstore':
					kuji = body.slice(7)
					reply(mess.wait)
					anu = await getBuffer(`https://api.vhtear.com/playstore?query={kuji}&apikey=VHgsu8829hhuaiBahaki`)
				...
				case 'clearall':
					...
					break
				case 'bc':
					if (!isOwner) return reply('Lu bukan owner tod')
					if (args.length < 1) return reply('Iya ownerku, mau umumkan hal apa?🤔')
					anu = await client.chats.all()
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						const encmedia = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek
						buff = await client.downloadMediaMessage(encmedia)
						for (let _ of anu) {
							client.sendMessage(_.jid, buff, image, {caption: `[ PENGUMUMAN REY BOT ]\n\n${body.slice(4)}`})
						}
